...
import { formatDate, formatTimeAgo } from "../../../../util/formatDate.js";
            ...
            <div className="flex-1 bg-card rounded-xl border border-badge overflow-hidden">
                <div className="h-full flex flex-col items-center justify-center text-center p-8">
                    ...
                    <p className="text-secondary-text max-w-sm">
                        Select a report from the list to view details and take
                        action.
                    </p>
                </div>
            </div>
        ...
        <div className="flex-1 bg-card rounded-xl border border-badge overflow-hidden">
            {selectedReport ? (
                <div className="h-full flex flex-col">
                    ...
                    <div className="p-6 border-b border-badge flex items-start justify-between">
                        <div className="flex-1">
                            ...
                            <p className="text-secondary-text text-sm">
                                ...
                                Product: {selectedReport.productTitle}
                            </p>
                        </div>
                    </div>
                                ...
                                <div className="flex items-center justify-between mb-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-semibold text-primary-text">
                                            {selectedReport.reviewId?.userId
                                                ?.name ||
                    ...
                    {!isResolved && (
                        <ReportActionButtons id={selectedReport._id} />
                    )}
                </div>
            ) : (
