  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          onClick={onExport}
          className="flex items-center gap-2 px-4 py-2.5 bg-(--color-card) border border-(--color-badge)/30 rounded-lg text-(--color-primary-text) hover:border-(--color-primary) transition-colors"
        >
          <Download size={18} />
