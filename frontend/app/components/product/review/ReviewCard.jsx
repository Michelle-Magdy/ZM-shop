import { useAuth } from "@/app/context/AuthenticationProvider.jsx";
import StarRating from "@/app/UI/StarRating.jsx";
    ...
    <>
      <div className="border-b border-badge last:border-0 pb-6 last:pb-0">
        ...
        <div className="space-y-2">
          {title && (
            <h4 className="font-bold text-(--color-primary-text)">{title}</h4>
          )}
