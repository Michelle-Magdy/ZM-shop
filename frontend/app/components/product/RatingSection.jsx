        ...
        <div className="mt-8 bg-(--color-card) rounded-2xl p-6 sm:p-8 border border-badge">
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                ...
                <div className="w-full lg:w-1/3 space-y-6">
                    ...
                    {/* Write Review Button */}
                    <button className="w-full py-3 px-4 bg-(--color-primary) text-(--color-brand-light) rounded-xl font-semibold hover:bg-primary-hover active:scale-95 transition-all duration-200">
                        Write a Review
                    </button>
                </div>
