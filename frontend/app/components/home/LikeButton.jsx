...
export default function LikeButton() {
  ...
  if (liked) {
    cssClass =
      " bg-white dark:bg-primary rounded-full w-7 h-7 shadow-lg flex justify-center items-center p-1 hover:cursor-pointer absolute top-2 right-2 transition-all duration-300 ease-in-out";
  } else {
    cssClass =
