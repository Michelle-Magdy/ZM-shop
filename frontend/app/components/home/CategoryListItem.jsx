...
export default function CategoryListItem({ depth, category, handleClose }) {
  ...
  return (
    <>
      ...
      >
        <Link href={`/category/${category.slug}`} onClick={handleClose}>
          {depth > 0 && <MdKeyboardArrowRight className="inline! mr-0.5" />}
          {category.name}
        </Link>
