...
export default function Menu() {
    ...
    return (
        <div className=" p-3 flex items-center gap-4 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)]  dark:bg-[#1C1B1D] dark:shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1)] dark:text-secondary-text">
                    ...
                    (cat, i) =>
                        i < 5 && (
                            <Link
                                ...
                                className="text-md  hover:text-cyan-900 dark:hover:text-primary-text "
                            >
                                {cat.name}
                            </Link>
                        ),
