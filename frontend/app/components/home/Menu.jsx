...
export default function Menu() {
    ...
    return (
        <header className="p-3 flex sticky top-0 z-50 bg-white items-center gap-4 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)]  dark:bg-card dark:shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1)] dark:text-secondary-text">
