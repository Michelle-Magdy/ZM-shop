...
export default function SearchBar() {
    return (
        <div className="flex items-stretch w-full h-10 md:h-12 bg-[#f6f6f6] md:bg-white/10 md:backdrop-blur-sm rounded-full border border-white/20">
            ...
            />
            <div className="bg-primary text-white px-5 md:px-6 rounded-r-full -ml-3 cursor-pointer flex items-center justify-center hover:bg-[#1a5d6e] md:hover:bg-white/30 transition-colors">
