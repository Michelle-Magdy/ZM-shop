      ...
      <div className="group rounded-lg overflow-hidden relative w-full">
        <div className="relative overflow-hidden aspect-4/5 bg-white">
          {product.isBestSeller && (
            <p className="bg-[#0C4E4A] dark:bg-primary text-white rounded-tl-lg rounded-br-lg absolute top-0 left-0 z-10 py-1 px-2">
              best seller
            </p>
          )}
          <Image
        ...
        <div className="p-2 bg-card">
          <p className="text-primary font-bold dark:text-primary-text">
            {product.title}
          </p>
          <div className="bg-badge w-fit rounded-lg flex justify-center items-center gap-1 py-0 px-1 text-xs">
            <FaStar className="text-green-700 dark:text-[#e3e3e3]" />
